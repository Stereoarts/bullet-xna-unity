...
namespace BulletXNA.LinearMath
{
    public struct IndexedMatrix : IEquatable<IndexedMatrix>
    {
        ...
        public void SetMatrix4x4(ref UnityEngine.Matrix4x4 m)
        {
            _basis._el0.X = m.m00;
            _basis._el1.X = m.m10;
            _basis._el2.X = m.m20;
        ...
        public IndexedMatrix(UnityEngine.Matrix4x4 m)
        {
            _basis._el0.X = m.m00;
            _basis._el1.X = m.m10;
            _basis._el2.X = m.m20;
        ...
        public static implicit operator UnityEngine.Matrix4x4(IndexedMatrix im)
        {
