...
namespace BulletXNA.LinearMath
{
    public struct IndexedVector3
    {
        ...
        public static IndexedVector3 operator +(UnityEngine.Vector3 value1, IndexedVector3 value2)
        {
            IndexedVector3 vector;
            vector.X = value1.x + value2.X;
            vector.Y = value1.y + value2.Y;
        ...
        public static IndexedVector3 operator +(IndexedVector3 value1, UnityEngine.Vector3 value2)
        {
            IndexedVector3 vector;
            vector.X = value1.X + value2.x;
            vector.Y = value1.Y + value2.y;
        ...
        public static float Dot(ref IndexedVector3 a, ref UnityEngine.Vector3 b)
        {
            return (a.X * b.x) + (a.Y * b.y) + (a.Z * b.z);
        }

        public static float Dot(IndexedVector3 a, UnityEngine.Vector3 b)
        {
            return (a.X * b.x) + (a.Y * b.y) + (a.Z * b.z);
        }

        public static float Dot(UnityEngine.Vector3 a, IndexedVector3 b)
        {
            return (a.x * b.X) + (a.y * b.Y) + (a.z * b.Z);
        }
#endif
        ...
        public IndexedVector3 Normalized()
        {
            ...
            {
                return new IndexedVector3( 0.0f, 0.0f, 0.0f );
            }
#else
